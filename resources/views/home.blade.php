                            ...
                            <div class="col-md-10">
                                ...
                                <header>
                                    <div class="navbar tabs-nav">
                                        ...
                                        <label for="tabservices" class="label"><i class="fa fa-home fa-1x"></i>Personal
                                            information</label>
                                        <div class="tab">
                                            <h2>Personal Informaion</h2>
                                            <label for="firstName">First Name</label> <input type="text"
                                                placeholder="First Name" id="firstName"><br> <br>
                                            <label for="middleName">Middle Name</label> <input type="text"
                                                placeholder="Middle Name" id="middleName"><br> <br>
                                            <label for="lastName">Last Name</label> <input type="text"
                                                placeholder="Last Name" id="lastName"><br> <br>
                                            <label for="dateOfBirth">Date of Birth</label> <input type="date"
                                                id="dateOfBirth" name="dateofbirth"> <br><br>
                                            <label for="pob">Place of Birth</label> <input type="text"
                                                placeholder="place of birth" id="pob"> <br><br>
                                            <label for="idn">CNI Number</label> <input type="number"
                                                placeholder="id card number" name="idnumber" id="idn"><br><br>
                                            <label for="iddi">Place Id was issued</label> <input type="date"
                                                placeholder="place issued" name="iddateissued" id="iddi"> <br><br>
                                            <label for="idpost">iD card Post</label> <input type="text"
                                                placeholder="eg: sw18" name="idpost" id="idpost"><br><br>
