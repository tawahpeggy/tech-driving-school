        ...
        <div class="my-3 px-2 w-100">
            <div class="">
                <table class="table table-stripped fs-5">
                    ...
                    @for($i=1; $i <= 7; $i++)
                    <tr class="bb-b">
                        <th class="fw-bold fs-6 text-uppercase border-left border-right border-secondary">{{date('l', $i). $i}}</th>
                        <td class="border-left border-right fs-6"> empty<br><small class="px-2 t-y">__time__</small></td>
                        <td class="border-left border-right fs-6"> empty<br><small class="px-2 t-y">__time__</small></td>
                        <td class="border-left border-right fs-6"> empty<br><small class="px-2 t-y">__time__</small></td>
                        <td class="border-left border-right fs-6"> empty<br><small class="px-2 t-y">__time__</small></td>
                        <td class="border-left border-right fs-6"> empty<br><small class="px-2 t-y">__time__</small></td>
