                        ...
                        <tbody>
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>{{$item->price}}</td>
                                    <td>
                                        <a onclick="edit('{{$item->id}}')" class="btn btn-default t-y fs-4" title="edit mode"><i class="fas fa-edit "></i></a>
                                        <a href="" class="btn btn-default t-y fs-4" title="delete mode"><i class="fas fa-trash-alt "></i></a>
                                    </td>
                                </tr>
                                @php($cnt++)
                            @endforeach
